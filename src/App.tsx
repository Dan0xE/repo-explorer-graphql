...
function App() {
  ...
  const [repoList, setRepoList] = React.useState<Array<string>>([]);
  const [pageCount, setPageCount] = React.useState<
    SetStateAction<any> | number
  >(10);
  ...
  }, [pageCount, queryString, paginationKeyword, paginationString, queryUser]);
  ...
  return (
    <div className="App container mt-5">
      <h1 className="text-primary">
        <i className="bi bi-diagram-2-fill"></i>Repo Searcher
      </h1>
      <p className="lead">
